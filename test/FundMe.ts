...
describe("FundMe", function() {
  ...
  this.beforeEach(async function() {
    ...
    // The first param gives us the most recently deployed FundMe contract. This comes from hardhat-deploy package
    // The second param, deployer, is saying we want the FundKMe contract to link to the deployer.
